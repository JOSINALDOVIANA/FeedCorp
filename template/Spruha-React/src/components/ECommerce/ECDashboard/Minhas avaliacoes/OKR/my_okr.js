                                                        ...
                                                        <Card.Body>
                                                            <div className="d-flex justify-content-between">
                                                                <div className="d-flex flex-column align-items-start">
                                                                    <h5>{okr?.objective?.toUpperCase()}</h5>
                                                                </div>

                                                                <h2 className="d-flex flex-row text-warning">
                                                                    <span className="font-weight-bold px-1">
                                                                        {okr?.keys?.length}
                                                                    </span>
                                                                    {/* ICONE */}
                                                                    <i className="mdi mdi-key-variant icon-size float-start"></i>
                                                                </h2>
                                                            </div>
                                                            ...
                                                            <Button className="btn ripple btn-block" variant="primary"
                                                                onClick={() => {
                                                        ...
                                                        <Card.Body>
                                                            <div className="d-flex justify-content-between">
                                                                ...
                                                                <h2 className="d-flex flex-row">
                                                                    ...
                                                                    {/* ICONE */}
                                                                    <i className="mdi mdi-account-key icon-size float-start text-primary tx-37"></i>
                                                                </h2>
                                                            </div>
                                                            <div className="main-traffic-detail-item mx-1">
                                                                <div className="mb-0">
                                                                    <span>Concluído</span>
                                                                    <span>{(okr.progress) ? (okr.progress) : 0}%</span>
                                                                </div>
                                                            ...
                                                            <Button className="btn ripple btn-block" variant="info btn-rounded"
                                                                onClick={() => {
                                                                    navegar(`${process.env.PUBLIC_URL}/okr_concluido/`, { state: { ...values, okrselect: okr } })
                                                                }} >
                                                                Resumo
                                                            </Button>
                                                        </Card.Body>
