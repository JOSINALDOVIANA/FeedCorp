...
import Responder from "./CustumerPages/AVPR/Responder";
import "./index.scss";
import Loader from "./layouts/Loader/Loader";

// Dashboard
const Avpr = React.lazy(() => import("./CustumerPages/AVPR"));
const Criar = React.lazy(() => import("./CustumerPages/AVPR/Criar"));
